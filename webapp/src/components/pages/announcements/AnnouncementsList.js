            ...
            <div class="container-fluid" style={{width:"100%"}}>
                <div className="row">
                    ...
                    {[
                        ...
                        {
                            return <div><AnnouncementCard color={announcement.color} title={announcement.title} text={announcement.text} postedDate={announcement.postedDate} committee={announcement.name} externalLink={announcement.externalLink}/></div>
                        })
                    }
                    </div>
                </div>
